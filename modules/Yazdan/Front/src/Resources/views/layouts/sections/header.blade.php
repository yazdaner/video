            ...
            <div class="t-header-left">
                ...
                <div class="user-menu-account">
                    <div class="user-image">
                        <img src="{{auth()->user()->getAvatar(60)}}" alt="desction">
                    </div>
                        ...
                        <ul>
                            ...
                            <li class="d-flex">
                                <form action="{{route('logout')}}" method="post">
                                    @csrf
                                    <a onclick="event.preventDefault(); this.parentElement.submit();">خروج</a>
                                </form>
                            </li>
                        </ul>
                    </div>
    ...
    <nav id="navigation" class="navigation">
        ...
        <div class="container">
            <ul class="nav">
                ...
                <li class="main-menu @if(count($category->subCategory)) has-sub @endif"><a href="{{$category->path}}">{{$category->title}}</a>
